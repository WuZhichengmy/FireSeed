...
class EndLogicPart(PartBase):
	...
	def UpdateGameEndSecond(self):
		comp1 = serverApi.GetEngineCompFactory().CreateBlockInfo(serverApi.GetLevelId())
		info3 = comp1.GetBlockNew((132, 74, -60), 0)
		info4 = comp1.GetBlockNew((132, 74, -61), 0)
		self.LogInfo("info3:" + str(info3))
		if info3['name'] == 'minecraft:air' or info4['name'] == 'minecraft:air':
			self.GameEnd("僵尸")
			return
		if self.showGameEndSecond:
