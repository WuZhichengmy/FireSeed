...
@registerGenericClass('ExplosionBluePrintPart')
class ExplosionBluePrintPart(PartBase):

    def __init__(self):
        super(ExplosionBluePrintPart, self).__init__()
        self.name = '蓝图零件'
        self.description = '蓝图零件'
        self.bpFiles = ['ExplosionBluePrintPart.bp']
        self.replicated = []
